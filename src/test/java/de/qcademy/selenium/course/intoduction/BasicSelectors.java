package de.qcademy.selenium.course.intoduction;
...
public class BasicSelectors {
    ...
    @BeforeEach //vor jedem testfall in der testklasse wird eine neue Crome Driver Instanz erstellt
    void setup(){
    ...
    void registrationTest() throws InterruptedException {
        //arrange
        String email = "jess.nd@yandex.ru";
        String vorname = "Janna";
        String nachname = "Wayne";
        String password = "blablabla";
        String expectedUsername = "John Wayne";
        ...
        // Asserts
        Assertions.assertEquals("John Wayne", actualUsername);
